    ...
    <main className="text-white min-h-screen relative overflow-hidden">
      ...
      <div className="fixed top-0 w-full z-30 backdrop-blur-md bg-black/30 border-b border-white/10">
        <div className="max-w-6xl mx-auto flex justify-between items-center px-6 py-4">
          <h1 className="text-yellow-400 font-bold">Qnex Algo</h1>
      ...
      <section className="py-24 relative z-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="mt-10 space-y-6 text-gray-300 text-lg">
            <p>Our strategy focuses on disciplined risk control and capital preservation.</p>

            <p>
              Maximum drawdown maintained within
              <span className="text-yellow-400 font-semibold"> 15% – 20% </span>
            </p>

            <p>Structured position sizing and stop-loss mechanisms are used.</p>

            <p>No aggressive or high-risk trading strategies are used.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative z-20">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-semibold">Investment Plan</h2>

          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white/5 p-6 rounded-xl">
              <h3 className="text-yellow-400 font-semibold">Starter</h3>
              <p className="mt-2">$500 – $1,000</p>
            </div>

            <div className="bg-white/5 p-6 rounded-xl">
              <h3 className="text-yellow-400 font-semibold">Growth</h3>
              <p className="mt-2">$1,000 – $5,000</p>
            </div>

            <div className="bg-white/5 p-6 rounded-xl">
              <h3 className="text-yellow-400 font-semibold">Advanced</h3>
      ...
      <section className="py-28 text-center relative z-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <a href="https://t.me/yourgroup">
            <button className="mt-8 px-10 py-4 bg-yellow-400 text-black rounded-lg font-semibold">
              Join Now
            </button>
          </a>
        </div>
